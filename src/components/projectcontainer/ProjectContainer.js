...
const ProjectContainer = () => {
  const projects = [
    ...
    },
    {
      ...
      link: "https://modern-kitchen-ui-ux.vercel.app/",
    },
    {
      img: require("../../assets/images/food-ordering-app.png"),
      title: "Food Ordering App",
      desc: "Created a high-performing food ordering app with React, Parcel, and Swiggy API integration. Advanced features like HMR, caching, and lazy loading enhance user experience. Utilized React Hooks, Redux Toolkit, and Jest for robust state management and testing. TailwindCSS ensures a visually appealing and responsive design.",
      link: "https://github.com/amnipriyasowrirajan/foodiepalapp",
    },
  ];
  return (
    <Element className="projectcontainer" id="projects">
      <h1>Projects</h1>
      <p>
        Here are some projects which I have done to make the lives of people
        easy.
      </p>
